            ...
            <div className="flex flex-row">
                <div className="w-full mx-auto py-10 flex flex-col sm:flex-row bg-white my-12 rounded-xl" >
                    <div className="w-3/5 mx-auto sm:m-0">
                        <div className=" ">
                            <Image src={`https://pangasari.herokuapp.com/${userData.image}`} alt="Image untuk profile mahasiswa" Stylee="w-32 h-32 rounded-full mx-auto relative" isStyle=" w-auto relative upload"/>
                        </div>
                        <div>
                            <label for="type-file" >
